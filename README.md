...
| **[Two-mode input shaper](https://hannott.github.io/KlipperVisuals/two_mode_shaper.html)** | A prototype shaper for axes with two resonances — the convolution of a single-mode shaper tuned to each peak — vs single-mode and broadband alternatives. |
